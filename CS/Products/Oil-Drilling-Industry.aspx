<%@ Page Title="" Language="C#" MasterPageFile="~/CS/MasterPage.master" AutoEventWireup="true" CodeFile="Oil-Drilling-Industry.aspx.cs" Inherits="CS_Products_Oil_Drilling_Industry" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>JSC Chemicals - Oil/Drilling-Industry</title>
</asp:Content>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 portfolio">
                        <h2 class="portfolio-title">Oil/ Drilling Industry</h2>
                    ...
                    <div class="col-lg-6 portfolio-info">
                        ...
                        <p>
                            ...
                            The very high purity grade salt is used in drilling to stabilize the drilling process.
        The salt with purity of 99.5% used in the process.
                        ...
                        <ul>
                            ...
                            <li><strong>Packaging options</strong>:<br />
                                50kgs/ 1000Kgs/ 1200kgs Jumbo PP Woven Bags
                            </li>
