<%@ Page Title="" Language="C#" MasterPageFile="~/CS/MasterPage.master" AutoEventWireup="true" CodeFile="Water-Softner-Tablet.aspx.cs" Inherits="CS_Products_Water_Softner_Tablet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>JSC Chemicals - Water-Softner-Tablet</title>
            ...
            <div class="container">
                ...
                <div class="row">
                     ...
                     <div class="col-lg-4 portfolio">
                        <h2 class="portfolio-title">Water Softner Tablet</h2>
                   ...
                   <div class="col-lg-6 portfolio-info">
                        ...
                        <p>
                           ...
                           Purity range between 99% to 99.60% with CA+ & MG+ < 0.05%
                            <br />
                            <br />
                          <strong>  Tablet Size:</strong> <br />Height 10-12 mm, Diameter: 22mm, Weight: 10 gms
                           

                        </p>
                         <ul>
                            <li><strong>Application</strong>:<br /> Water softner for swimming pools, hospitals & hotels <br /></li>
                            <li><strong>Packaging options</strong>:<br /> 25kgs/ 50kgs PP/ HDPE Woven Bags
</li>
