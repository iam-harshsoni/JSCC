<%@ Page Title="" Language="C#" MasterPageFile="~/CS/MasterPage.master" AutoEventWireup="true" CodeFile="Refined-Washed-Salt.aspx.cs" Inherits="CS_Products_Refined_Washed_Salt" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>JSC Chemicals - Refined-Washed-Salt</title>
</asp:Content>
            ...
            <div class="container">
                ...
                <div class="row"> 
                     ...
                     <div class="col-lg-4 portfolio">
                        <h2 class="portfolio-title">Refined Washed Salt</h2>
                     ...
                     <div class="col-lg-6 portfolio-info">
                        ...
                        <p>
                            ...
                            We offer raw washed salt passed through centrifuge machine. This salt is free from Mud/Dirt after the washing.
                            <br />
                            <br />
                            Purity range between 98.5% to 99% NACL
                           

                        </p>
                         <ul>
                            <li><strong>Application</strong>: <br />Household Cleaning Products like Detergent soaps, Washing powder <br /></li>
                            <li><strong>Packaging options</strong>:<br /> 20kgs, 25kgs, 40kgs, 50kgs or 1000kgs Jumbo PP or HDPE Bags</li>
