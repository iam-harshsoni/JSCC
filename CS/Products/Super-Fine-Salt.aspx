<%@ Page Title="" Language="C#" MasterPageFile="~/CS/MasterPage.master" AutoEventWireup="true" CodeFile="Super-Fine-Salt.aspx.cs" Inherits="CS_Products_Super_Fine_Salt" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>JSC Chemicals - Super-Fine-Salt</title>
</asp:Content>
            ...
            <div class="container">
                ...
                <div class="row">
                      ...
                      <div class="col-lg-4 portfolio">
                        <h2 class="portfolio-title">Super Fine Salt</h2>
                    ...
                    <div class="col-lg-6 portfolio-info">
                        ...
                        <p>
                            ...
                            We offer super fine salt generally used in bakery & biscuits industry.
                          
                        </p>
                        <ul>
                            <li><strong>Application</strong>: <br />Personal care including toothpaste, cosmetics, pharmaceuticals, Bakery & Biscuit 
                                <br />
                            </li>
                            <li><strong>Packaging options</strong>:<br />
                                25kgs, 50kgs PP/HDPE Bags</li>
